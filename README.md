...
- **Windows / macOS :**  
Allez sur [python.org](python.org).  
...
Sur ce git (Ethire/cities-pipelines), vous trouverez tous les fichiers relatifs au code de l’interface utilisateur ainsi que ceux du simulateur avec un exemple de simulation.
...
- Une icône en haut à droite de la fenêtre permet de générer un fichier d’entrée (fichier .inp) qui sera ensuite importé dans le code du simulateur.
